        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Edit your dish</h3>
            ...
            ` @endif
                <form action="/dishes/{{$dish->id}} " method="POST" enctype="multipart/form-data"> <!-- enctype par mha file upload ya mar -->
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <img width="100" height="100" src="{{url('/images/'.$dish->image)}}" />
